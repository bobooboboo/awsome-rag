...
class LocalEmbeddingModel(BaseEmbedding):
    ...
    def __init__(self, model_name: Optional[str] = None):
        ...
        self._huggingface_model = HuggingFaceEmbedding(model_name=model_name)
    ...
    def _get_text_embedding(self, text: str) -> List[float]:
        ...
        Returns:
            文本的向量表示
        """
        return self._huggingface_model.get_text_embedding(text)
    ...
    def _get_query_embedding(self, query: str) -> List[float]:
        ...
        Returns:
            查询文本的向量表示
        """
        return self._huggingface_model.get_query_embedding(query)
